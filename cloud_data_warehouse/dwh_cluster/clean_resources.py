...
def delete_iam_role(DB_IAM_ROLE_NAME):
...
def main():
    ...
    DB_CLUSTER_IDENTIFIER = config.get("AWS", "DB_CLUSTER_IDENTIFIER")
    DB_IAM_ROLE_NAME      = config.get("AWS", "DB_IAM_ROLE_NAME")
    ...
    delete_iam_role(DB_IAM_ROLE_NAME)
